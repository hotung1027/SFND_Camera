...
void gradientSobel() {
  ...
  // beginning of this leesson (refer to the equations for gradient direction
  // and magnitude) for every pixel position. Also, apply different levels of
  // Gaussian blurring before applying the Sobel operator and compare the
  // results.
